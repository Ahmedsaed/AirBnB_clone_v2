...
run_tests:
	...
	HBNB_ENV=test HBNB_MYSQL_USER=root HBNB_MYSQL_PWD=hbnb_dev_pwd HBNB_MYSQL_HOST=127.0.0.1 HBNB_MYSQL_DB=hbnb_dev_db HBNB_TYPE_STORAGE=db $(PYTHON) -m unittest discover tests
